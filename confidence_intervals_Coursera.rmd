...
mlv(samp$area, method = "mfv")
#The tipical area is 1476.283 or 1416
```
...
# type your code for the Exercise here, and Knit
Zp = (1499.69 - 1476.283)/(462.8179/sqrt(60))
```
...
#ci_99 <- ci%>%
#  summarise(upper_99 = (upper - ((upper-lower)/2)) + ((((upper-lower)/2)/1.96)*2.58),
#            lower_99 = (upper - ((upper-lower)/2)) - ((((upper-lower)/2)/1.96)*2.58))
